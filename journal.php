	...
	<body><center></br></br>
		...
		<table>
			<tr><td colspan="2" align="center">
				...
				<a href="addjournal.php"><input type="button" value="Add Entry" class="basic_button"/></a></td></tr>
		</table>
		<!-- ------------------------------------------------------------------------------ -->	
		
		<table border="0" cellpadding="2" cellspacing="5" bgcolor="#1490CC">
		<th colspan="2">Search Widget?</th>
		<form action="journal.php?criteria" method="POST">
			<tr><td>Subject: </td>
		...
		if(isset($_GET['criteria'])){
			...
			while($row = mysql_fetch_array($query)){
				...
				if(checkRange($start_date, $end_date, $table_date)){
					echo $date . " " . $time . " " . $subject . " " . $content;}
			}
		}
	}
